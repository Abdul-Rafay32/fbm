...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    try {
      ...
      console.warn("Gemini API key is missing. Using high-quality offline fallback.");
      ...
      res.status(200).json({
        text: `[Offline Demo Mode] ${randomReply}\n\n*(Note: To connect the real-time Gemini AI, please add the GEMINI_API_KEY to your Vercel Project Settings > Environment Variables.)*`
      });
      return;
    }
